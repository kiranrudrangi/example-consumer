...
describe('API2 Pact test', () => {
  beforeAll(() => mockProvider.setup());
  afterEach(() => mockProvider.verify());
  afterAll(() => mockProvider.finalize());

  describe('2retrieving a product', () => {
    test('2ID 10 exists', async () => {
      // Arrange
    ...
    test('2product does not exist', async () => {
  ...
  describe('2retrieving products', () => {
    test('2products exists', async () => {
      // set up Pact interactions
      const expectedProduct = { id: '10', type: 'CREDIT_CARD', name: '28 Degrees' }
